...
const Menu: React.FunctionComponent<IMenuProps> = (props) => {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger>
        <IoIosMenu className='text-2xl text-primary'/>
      </SheetTrigger>
      <SheetContent side='left' className='gap-0' >
        <SheetHeader>
          <SheetTitle className='flex gap-2 items-center'>
            <h1 className='cursor-pointer text-primary font-semibold lg:text-3xl text-xl' onClick={() => navigate('/')}>Door2Door</h1>
          </SheetTitle>
          <Separator className=''/>
        </SheetHeader>
        ...
        <div className='mx-2 space-y-10'>
          ...
          <div className='space-y-4'>
            <div className='flex justify-between items-center ' onClick={() => handleNavigationClick('/settings')}>
            ...
            <div className='space-y-4'>
              ...
              <div onClick={() => handleNavigationClick('/settings/currency')}>
                <div className='flex gap-4 items-center'>
              ...
              <div onClick={() => handleNavigationClick('/settings/language')}>
                <div className='flex gap-4 items-center'>
