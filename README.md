...
<!---->
<!-- ### Add a new product -->
<!-- - First you need to be signed in with a confirmed account -->
<!-- - Then click on the user icon on the top right saying Hello there, [your name], and click add product -->
<!---->
<!-- ### Change Currency -->
