...
const Login = (props)=>{
    ...
    const onSubmit = async (data)=>{
        ...
        const { data: userInfo, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handlePasswordLogin"])(email, password);
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error logging in: " + error.message);
...
//# sourceMappingURL=src_b4976616._.js.map